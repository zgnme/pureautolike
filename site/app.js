...
const locales = {
  ru: {
    ...
    seoTitle: 'Бесплатный Pure автолайкер 2026 для Pure Web, без отдельного приложения.',
    seoIntro: 'PureAutoLike нужен тем, кто ищет бесплатный автолайкер Pure, Pure auto liker 2026, рабочее Chrome-расширение, открытие доступных фото Pure и Telegram-уведомления по событиям в Pure Web.',
    ...
    seoChromeCopy: 'Основной публичный канал установки - Chrome Web Store; код, политика приватности и обратная связь остаются на GitHub, сторонней аналитики в расширении нет.',
    ...
    finalTitle: 'Проверь бесплатную beta на своей вкладке Pure.',
  ...
  en: {
    ...
    seoTitle: 'Free Pure auto liker 2026 for Pure Web, without a desktop app.',
    seoIntro: 'PureAutoLike is for people searching for a free Pure auto liker, Pure app auto like 2026, a working Chrome extension, accessible Pure photos, and Telegram notifications for Pure Web events.',
    seoAutoTitle: 'Auto liker',
    seoAutoCopy: 'Auto-like runs inside the open Pure Web tab and clicks visible likes without a separate desktop bot.',
    seoChromeTitle: 'Chrome extension',
    seoChromeCopy: 'Chrome Web Store is the main public install channel; source, privacy policy, and feedback stay available on GitHub, with no third-party analytics in the extension.',
    seoPureTitle: 'Pure Web automation',
    ...
    finalTitle: 'Test the free beta on your own Pure tab.',
